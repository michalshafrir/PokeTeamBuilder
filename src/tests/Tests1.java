...
public class Tests1 {
	...
	public void testColorSort(){
		...
		assertTrue(out.equals("gorebyss sylveon musharna mesprit slowbro mr-mime mew slowking milotic diancie aromatisse clefable cherrim wigglytuff porygon smoochum flaaffy lickilicky blissey mime-jr munna corsola spritzee cherubi clefairy exeggcute lickitung audino whismur jigglypuff cleffa slowpoke igglybuff snubbull miltank luvdisc alomomola chansey hoppip skitty happiny "));
	}
	
	//tests the scoring of arceus' moves, that each has a proper score and then sorts them
	@org.junit.Test
